 ...
 */
@Autonomous (name = "Red 2 With Vuforia", group = "Testing")
public class Red2TestVuforia extends LinearOpMode implements Constants {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        knockJewelBlue();
        if (cryptoKey == RelicRecoveryVuMark.LEFT){
            gyroDrive(DRIVE_SPEED, -17, 0.0);
            gyroTurn(TURN_SPEED, -90.0);
            gyroDrive(DRIVE_SPEED, -28, -90.0);
            gyroTurn(TURN_SPEED, 0.0);
            robot.leftClaw.setPosition(LEFT_OPEN_POSITION);
            robot.rightClaw.setPosition(RIGHT_OPEN_POSITION);
            gyroDrive(DRIVE_SPEED, -14, 0.0);

        } else if (cryptoKey == RelicRecoveryVuMark.CENTER){
            gyroDrive(DRIVE_SPEED, -17, 0.0);
            gyroTurn(TURN_SPEED, -90.0);
            gyroDrive(DRIVE_SPEED, -18, -90.0);
            gyroTurn(TURN_SPEED, 0.0);
            robot.leftClaw.setPosition(LEFT_OPEN_POSITION);
            robot.rightClaw.setPosition(RIGHT_OPEN_POSITION);
            gyroDrive(DRIVE_SPEED, -14, 0.0);
    ...
    public void knockJewelBlue(){
        //So that the color sensor led turns on
        ...
        if (Onetime && opModeIsActive()) {
            ...
            telemetry.addData("Holding", "Glyph");
                ...
                if (robot.colorSensorJewel.red() > robot.colorSensorJewel.blue() && robot.colorSensorJewel.red() > robot.colorSensorJewel.green()) {
                    ...
                    //If it didn't see red, then it would be blue. TRIAL!
                    ...
                    sleep(1000);
                    telemetry.addData("Jewel Blue", "is pushed");
                    //Put the Lewel Pusher Up
                    robot.jewelPusher.setPosition(JEWEL_PUSHER_UP_POSITION);
                    //Go back to initial positon
                    gyroDrive(DRIVE_SPEED, 3, 0.0);
                    sleep(1000);
                    telemetry.addData("Back to", "Initial Position");
                    telemetry.addData("Moved to ", "the triangle");
